(module
 ...
 (data $11 (i32.const 1568) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\t")
 ...
 (start $~start)
 (func $assembly/index/countPrime (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  i32.const 2
  local.set $1
 ...
 (func $assembly/index/sumOfSquares (param $0 i32) (result i64)
  (local $1 i32)
  (local $2 i64)
  i32.const 1
  local.set $1
 ...
 (func $assembly/index/sumOfArray (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
   ...
   loop $for-loop|0
    ...
    if
     ...
     if
      ...
      local.get $5
      i32.store
      block $__inlined_func$~lib/rt/itcms/__renew$125
       i32.const 1073741820
       local.get $1
       i32.const 1
       i32.shl
