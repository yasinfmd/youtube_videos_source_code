(module
 ...
 (data $10 (i32.const 492) ",\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\1a\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00.\00t\00s\00\00\00")
 (data $11 (i32.const 544) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\t\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 (export "countPrime" (func $assembly/index/countPrime))
 (export "sumOfSquares" (func $assembly/index/sumOfSquares))
 (export "fibonacci" (func $assembly/index/fibonacci))
 (export "sumOfArray" (func $assembly/index/sumOfArray))
 (export "memory" (memory $0))
 (start $~start)
 (func $assembly/index/isPrime (param $n i32) (result i32)
  (local $i i32)
  local.get $n
  i32.const 2
  i32.lt_s
 ...
 (func $assembly/index/countPrime (param $max i32) (result i32)
  (local $count i32)
  (local $n i32)
  i32.const 0
  local.set $count
 ...
 (func $assembly/index/sumOfSquares (param $max i32) (result i64)
  (local $total i64)
  (local $i i32)
  i64.const 0
  local.set $total
 ...
 (func $assembly/index/sumOfArray (param $max i32) (result i32)
  (local $1 i32)
  (local $arr i32)
  (local $total i32)
  (local $i i32)
